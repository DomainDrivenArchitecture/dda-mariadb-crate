...
(ns dda.pallet.dda-mariadb-crate.main
  (:gen-class)
  (:require
...
(defn usage [options-summary]
  (str/join
   \newline
   ["dda-mariadb-crate installs a variety of standard software and configs on your personal desktop"
    ""
    "Usage: java -jar dda-mariadb-crate-[version]-standalone.jar [options] ide-spec-file"
    ""
    "Options:"
    options-summary
    ""
    ...
    "  - has to be a valid MariaDomainConfig (see: https://github.com/DomainDrivenArchitecture/dda-mariadb-crate)"
    ""]))
